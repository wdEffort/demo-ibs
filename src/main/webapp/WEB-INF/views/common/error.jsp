        ...
        <div id="content">
            ...
            <div class="container-fluid">
                ...
                <div class="text-center">
                    <div class="error mx-auto" data-text="ERR">ERR</div>
                    <p class="lead text-gray-800 mb-5">System Error Page</p>
                    <p class="text-gray-500 mb-0">시스템에서 치명적인 ERROR가 발생하였습니다.</p>
